...
module.exports = {
    ...
    async execute({ inter }) {
        ...
        const embed = new EmbedBuilder()
            .setTitle(await Translate('Tap to buttons to control the music u know'))
            .setImage(inter.guild.iconURL({ size: 4096, dynamic: true }))
            .setColor('#2f3136');

        inter.editReply({ content: await Translate(`Sending controller<${channel}>... <✅>`) });
